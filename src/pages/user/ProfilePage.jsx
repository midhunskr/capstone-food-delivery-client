...
//             // Show specific messages based on error response
//             if (error.response && error.response.status === 404) {
//                 toast.error("No orders found"); // Backend might return 404 for no orders
//             } else {
//                 toast.error("Error fetching order data"); // Generic error message for other issues
//             }
...
export const ProfilePage = () => {
    ...
    const renderSectionContent = () => {
        switch (activeIndex) {
            ...
            case 1: // Addresses
                return (
                    <div className="bg-bg-white p-4 rounded-lg shadow-md">
